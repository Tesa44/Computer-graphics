...
def render(time):
    ...
    # Ściany boczne
    draw_wall("front", [-2.5, 0.0, -2.5] , [0.0, 5.0, 0.0], [2.5, 0.0, -2.5],[0.0, 0.0],[0.5, 0.5],[1.0,0.0])
    draw_wall("right", [2.5, 0.0, -2.5], [0.0, 5.0, 0.0], [2.5, 0.0, 2.5], [1.0, 0.0],[0.5, 0.5],[1.0, 1.0])
    draw_wall("back", [2.5, 0.0, 2.5], [0.0, 5.0, 0.0],[-2.5, 0.0, 2.5], [1.0, 1.0],[0.5, 0.5],[0.0, 1.0])
    draw_wall("left", [-2.5, 0.0, 2.5], [0.0, 5.0, 0.0],[-2.5, 0.0, -2.5], [0.0, 1.0],[0.5, 0.5],[0.0, 0.0])
